...
## Framework  
![Figure 1: Illustration of locality-constrained affine subspace coding (LASC). Figure 1(a) shows
our idea of LASC and a comparison with LLC. Figure 1(b) demonstrates the feature coding
process and the dictionary of LLC is visually compared with that of LASC.](https://github.com/icyzhang0923/Locality-constrained-Affine-Subspace-Coding/blob/master/LASC%20_framework.jpg)
## Environment     
